...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .intro-title {
    ...
    color: var(--gold);
    text-shadow: 0 0 20px var(--gold2), 3px 3px 0 var(--shadow);
    text-align: center;
    line-height: 1.8;
    ...
    <div class="nameplate-inner">
      ...
      <div class="name-block">
        ...
        <div class="contact-row">
          ...
          <span>·</span>
          <a href="/cdn-cgi/l/email-protection#ee9d8f83879d818281838180dddfae89838f8782c08d8183">✉ <span class="__cf_email__" data-cfemail="7201131f1b011d1e1d1f1d1c414332151f131b1e5c111d1f">[email&#160;protected]</span></a>
        </div>
        <div class="stars-row">
...
<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>
  ...
  function startGame() {
    ...
    // Play a little "chime" sequence with Web Audio if available
    try {
  ...
  document.addEventListener('keydown', e => {
    const intro = document.getElementById('intro');
    if (intro.style.display !== 'none' && !intro.classList.contains('fade-out')) {
