...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .job-title-h{font-size:1.4rem;color:var(--green);margin-bottom:.6rem;}
  ...
  .skill-item{background:var(--panel2);border:2px solid var(--border);padding:.5rem .7rem;display:flex;align-items:center;gap:.5rem;font-size:1.1rem;line-height:1.4;cursor:pointer;transition:transform .15s,box-shadow .15s;}
  ...
  .cert-item{background:var(--panel2);border:2px solid var(--border);padding:.5rem .8rem;display:flex;align-items:center;gap:.6rem;font-size:1.2rem;cursor:pointer;transition:transform .15s,box-shadow .15s;}
